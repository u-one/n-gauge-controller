...
const SimpleTrainController::ControlMapping SimpleTrainController::_mappings[] = {
...
const int SimpleTrainController::_mappingCount = sizeof(_mappings) / sizeof(ControlMapping);

SimpleTrainController::SimpleTrainController(MotorController* motorController, RotarySwitch* rotarySwitch, TwoLinesCharacterDisplay* display)
    : TrainController(motorController, display), _rotarySwitch(rotarySwitch) {
...
void SimpleTrainController::begin() {
    // 初期状態を読み取り
...
void SimpleTrainController::update() {
    // ロータリースイッチの状態を読み取り
